...
class Render{
   constructor(){
       ...
       let f7=(o)          => {  //total_persona_mes
                                let vac="";
                                if(teamView.buscarPorNombre(o.key)===undefined){
                                    vac="color:#F8F8F8;";
                                }
                                //o.horasReal
                                let horas=teamView.getHorasMes(o.key,o.mes)
                                ...
                                <input class="dedi" ${o.horasReal>=160?'style="color:red"':''} readonly id="r-${o.key}-${o.mes}" value="${horas.toFixed(1)}">                                
                                <span>H</span>
                               </div>`
                                }                      
       ...
       let f9=(arr)      =>  {   //console.log("f9"+arr.nombre,typeof arr.dirty ==="undefined")
        ...
        let f11=(o)      => { 
                                ...
                                if(o.inTeam){
                                    rowMo.set(0,`<tr name="${o.ind==0?'o.'+o.usr:'h.'+o.usr}" class="${o.ind==0?'head-cell':''}" style="${o.ind==0?'':'display:none'}">
                                        ...
                                        rowMo.set(10,`<td class="${o.ind==0?'head-cell':''}" ${this.formatCell(o.rOct_,o.pOct_)}>P:${o.pOct_==null?0:(o.pOct_).toFixed(1)}H<br/>R:( ${o.rOct_==null?0.00:(o.rOct_).toFixed(1)}H) T:(${o.ind==0?teamView.getHorasMes(o.usr,10).toFixed(1):""}H)</td>`);
                                        rowMo.set(11,`<td class="${o.ind==0?'head-cell':''}" ${this.formatCell(o.rNov_,o.pNov_)}>P:${o.pNov_==null?0:(o.pNov_).toFixed(1)}H<br/>R:( ${o.rNov_==null?0.00:(o.rNov_).toFixed(1)}H) T:( ${o.ind==0?teamView.getHorasMes(o.usr,11).toFixed(1):""}H)</td>`);
                                        rowMo.set(12,`<td class="${o.ind==0?'head-cell':''}" ${this.formatCell(o.rDic,o.pDic)}>P:${o.pDic_==null?0:(o.pDic_).toFixed(1)}H<br/>R:( ${o.rDic_==null?0.00:(o.rDic_).toFixed(1)}H) T:(${o.ind==0?teamView.getHorasMes(o.usr,12).toFixed(1):""}H)</td>`);
                                        rowMo.set(13,`<td class="${o.ind==0?'head-cell':''}" ${this.formatCell(o.rEne,o.pEne)} >P:${o.pEne==null?0.00:(o.pEne).toFixed(1)}H<br/>R:(${o.rEne==null?0.00:(o.rEne).toFixed(1)}H) T:(${o.ind==0?teamView.getHorasMes(o.usr,13).toFixed(1):""}H)</td>`);
                                        rowMo.set(14,`<td class="${o.ind==0?'head-cell':''}" ${this.formatCell(o.rFeb,o.pFeb)}>P:${o.pFeb==null?0.00:(o.pFeb).toFixed(1)}H<br/>R:( ${o.rFeb==null?0.00:(o.rFeb).toFixed(1)}H) T:(${o.ind==0?teamView.getHorasMes(o.usr,14).toFixed(1):""}H)</td>`);
                                        rowMo.set(15,`<td class="${o.ind==0?'head-cell':''}" ${this.formatCell(o.rMar,o.pMar)}>P:${o.pMar==null?0.00:(o.pMar).toFixed(1)}H<br/>R:( ${o.rMar==null?0.00:(o.rMar).toFixed(1)}H) T:(${o.ind==0?teamView.getHorasMes(o.usr,15).toFixed(1):""}H)</td>`);
                                        rowMo.set(16,`<td class="${o.ind==0?'head-cell':''}" ${this.formatCell(o.rAbr,o.pAbr)}>P:${o.pAbr==null?0:(o.pAbr).toFixed(1)}H<br/>R:( ${o.rAbr==null?0.00:(o.rAbr).toFixed(1)}H) T:(${o.ind==0?teamView.getHorasMes(o.usr,16).toFixed(1):""}H)</td>`);
                                        rowMo.set(17,`<td class="${o.ind==0?'head-cell':''}" ${this.formatCell(o.rMay,o.pMay)}>P:${o.pMay==null?0:(o.pMay).toFixed(1)}H<br/>R:( ${o.rMay==null?0.00:(o.rMay).toFixed(1)}H) T:(${o.ind==0?teamView.getHorasMes(o.usr,17).toFixed(1):""}H)</td>`);
                                        rowMo.set(18,`<td class="${o.ind==0?'head-cell':''}" ${this.formatCell(o.rJun,o.pJun)}>P:${o.pJun==null?0:(o.pJun).toFixed(1)}H<br/>R:( ${o.rJun==null?0.00:(o.rJun).toFixed(1)}H) T:(${o.ind==0?teamView.getHorasMes(o.usr,18).toFixed(1):""}H)</td>`);
                                        rowMo.set(19,`<td class="${o.ind==0?'head-cell':''}" ${this.formatCell(o.rJul,o.pJul)}>P:${o.pJul==null?0:(o.pJul).toFixed(1)}H<br/>R:( ${o.rJul==null?0.00:(o.rJul).toFixed(1)}H) T:(${o.ind==0?teamView.getHorasMes(o.usr,19).toFixed(1):""}H)</td>`);
                                        rowMo.set(20,`<td class="${o.ind==0?'head-cell':''}" ${this.formatCell(o.rAgo,o.pAgo)}>P:${o.pAgo==null?0:(o.pAgo).toFixed(1)}H<br/>R:( ${o.rAgo==null?0.00:(o.rAgo).toFixed(1)}H) T:(${o.ind==0?teamView.getHorasMes(o.usr,20).toFixed(1):""}H)</td>`);
                                        rowMo.set(21,`<td class="${o.ind==0?'head-cell':''}" ${this.formatCell(o.rSep,o.pSep)}>P:${o.pSep==null?0:(o.pSep).toFixed(1)}H<br/>R:( ${o.rSep==null?0.00:(o.rSep).toFixed(1)}H) T:( ${o.ind==0?teamView.getHorasMes(o.usr,21).toFixed(1):""}H)</td>`);
                                        rowMo.set(22,`<td class="${o.ind==0?'head-cell':''}" ${this.formatCell(o.rOct,o.pOct)}>P:${o.pOct==null?0:(o.pOct).toFixed(1)}H<br/>R:( ${o.rOct==null?0.00:(o.rOct).toFixed(1)}H) T:(${o.ind==0?teamView.getHorasMes(o.usr,22).toFixed(1):""}H)</td>`);
                                        rowMo.set(23,`<td class="${o.ind==0?'head-cell':''}" ${this.formatCell(o.rNov,o.pNov)}>P:${o.pNov==null?0:(o.pNov).toFixed(1)}H<br/>R:( ${o.rNov==null?0.00:(o.rNov).toFixed(1)}H) T:(${o.ind==0?teamView.getHorasMes(o.usr,23).toFixed(1):""}H)</td>`);
                                        rowMo.set(24,`<td class="${o.ind==0?'head-cell':''}" ${this.formatCell(o.rDic,o.pDic)}>P:${o.pDic==null?0:(o.pDic).toFixed(1)}H<br/>R:( ${o.rDic==null?0.00:(o.rDic).toFixed(1)}H) T:(${o.ind==0?teamView.getHorasMes(o.usr,24).toFixed(1):""}H)</td>`);
        ...
        let f13=(obj)    => {   //proyecto_calendarior
                                let edo=obj.Fase;
                                ...
                                return `<div class="proyecto" id="${obj.IDp}.${obj.fase}.${obj.mesi}" data-prep="${dataSinPrep}" style="${styloSinPrep}"  ondrop="staffing.drop(event)" ondragover="util.allowDrop(event)">
                                   ...
                                   <div id="edit-${obj.IDp}-${obj.mes}" class="edit-block" style="display:none">${tcheck}
                                    <div>
                                        ...
                                        <span id="ref-${obj.IDp}.${obj.fase}.${obj.mesi}" style="color:green">${obj.totHorasPlan.toFixed(1)}</span>&nbsp;&nbsp;cambio por:&nbsp;&nbsp;
