   ...
   constructor(){
       ...
       let f9=(arr)      =>  {   //console.log("f9"+arr.nombre,typeof arr.dirty ==="undefined")
        ...
        let f12=(obj,arr)=> { 
                                ...
                                <input type="text" id="id-${arr.nombre}-${obj.IDp}.${obj.fase}.${obj.mesi}-${arr.inOnSite}" onchange="tx_dedichange('${arr.nombre}','${obj.IDp}','${obj.fase}','${obj.mesi}',${arr.inOnSite})" class="horas-real" style="width: 27px;font-size:9px;${futuro?'color:black':''}" value="0">
                                </div>`;
